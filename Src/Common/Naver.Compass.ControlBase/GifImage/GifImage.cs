...
namespace Naver.Compass.Common
{
    ...
    public class GifImage : System.Windows.Controls.UserControl
    {
        ...
        public static readonly DependencyProperty IsAnimatingProperty = DependencyProperty.Register("IsAnimating", typeof(bool), typeof(GifImage), new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.AffectsMeasure | FrameworkPropertyMetadataOptions.AffectsRender, new PropertyChangedCallback(OnIsAnimatingChanged)));
        private static void OnIsAnimatingChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if(s)
            {
                obj.gifAnimation.Start();
            }
            else
            {
                obj.gifAnimation.Stop();
            }
        ...
        public bool IsAnimating
        {
            get
            {
                return (bool)this.GetValue(IsAnimatingProperty);
            }
            set
            {
                this.SetValue(IsAnimatingProperty, value);
            }
        }
        ...
        private void CreateGifAnimation(MemoryStream memoryStream)
        {
            ...
            gifAnimation.IsAnimating = IsAnimating;
