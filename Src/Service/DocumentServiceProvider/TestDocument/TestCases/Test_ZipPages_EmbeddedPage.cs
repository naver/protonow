...
{
    class Test_ZipPages_EmbeddedPage: TestCase
    {
        public Test_ZipPages_EmbeddedPage()
            : base("Test_ZipPages_EmbeddedPage")
        {
        }
        ...
        public override string Description
        {
            get
            {
                return "Test delete embedded page and directory filter in fastzip:\n" +
                    "* Create a document.\n" +
                    "* Create lots of pages.\n" +
                    "* Create menu, toast and dynamic panel in new pages.\n" +
                    "* Delete a panel page in dynamic panel.\n" +
                    "* Save the document and check if deleted embedded page is not in zip file.";
