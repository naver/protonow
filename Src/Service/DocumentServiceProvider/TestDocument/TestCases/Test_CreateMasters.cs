...
{
    class Test_CreateMasters : TestCase
    {
        public Test_CreateMasters()
            : base("Test_CreateMasters")
        {
        }
        ...
        public override string Description
        {
            get
            {
                return "Test create masters and add them to pages.\n"; 
            }
        }
        ...
        protected override void RunInternal()
        {
            ...
            master.MasterStyle.X = 100;
            master.MasterStyle.Y = 100;
