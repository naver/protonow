...
namespace Xceed.Wpf.AvalonDock.Themes
{
  public static class AeroColors
  {
    ...
    public static readonly ComponentResourceKey MainBackgroupKey = new ComponentResourceKey(typeof(AeroColors), "MainBackgroup");
    ...
    public static readonly ComponentResourceKey PanelTitleForegroundKey = new ComponentResourceKey(typeof(AeroColors), "PanelTitleForeground");
    public static readonly ComponentResourceKey PanelTitleBackgroundKey = new ComponentResourceKey(typeof(AeroColors), "PanelTitleBackground");
    public static readonly ComponentResourceKey PanelTitleBackgroundActiveKey = new ComponentResourceKey(typeof(AeroColors), "PanelTitleBackgroundActive");
    public static readonly ComponentResourceKey DocTabHeaderBgKey = new ComponentResourceKey(typeof(AeroColors), "DocTabHeaderBg");
    public static readonly ComponentResourceKey DocTabHeaderBorderActiveKey = new ComponentResourceKey(typeof(AeroColors), "DocTabHeaderBorderActive");
    public static readonly ComponentResourceKey DocTabHeaderBorderKey = new ComponentResourceKey(typeof(AeroColors), "DocTabHeaderBorder");
    public static readonly ComponentResourceKey DocTabHeaderForegroundActiveKey = new ComponentResourceKey(typeof(AeroColors), "DocTabHeaderForegroundActive");
    public static readonly ComponentResourceKey DocTabBorderKey = new ComponentResourceKey(typeof(AeroColors), "DocTabBorder");
    public static readonly ComponentResourceKey DocTabHeaderForegroundKey = new ComponentResourceKey(typeof(AeroColors), "DocTabHeaderForeground");
    public static readonly ComponentResourceKey WindowTitleBackgroundKey = new ComponentResourceKey(typeof(AeroColors), "WindowTitleBackground");
    public static readonly ComponentResourceKey WindowBorderColorKey = new ComponentResourceKey(typeof(AeroColors), "WindowBorderColorKey");
 
      
      //public static readonly ComponentResourceKey DocumentTabHeaderBg = new ComponentResourceKey(typeof(AeroColors), "DocumentTabHeaderBg");
    //public static readonly ComponentResourceKey DocumentTabHeaderBg = new ComponentResourceKey(typeof(AeroColors), "DocumentTabHeaderBg");
    //public static readonly ComponentResourceKey DocumentTabHeaderBg = new ComponentResourceKey(typeof(AeroColors), "DocumentTabHeaderBg");
    //public static readonly ComponentResourceKey DocumentTabHeaderBg = new ComponentResourceKey(typeof(AeroColors), "DocumentTabHeaderBg");
    //public static readonly ComponentResourceKey DocumentTabHeaderBg = new ComponentResourceKey(typeof(AeroColors), "DocumentTabHeaderBg");
