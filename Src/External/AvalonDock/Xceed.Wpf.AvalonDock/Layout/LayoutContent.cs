...
namespace Xceed.Wpf.AvalonDock.Layout
{
    ...
    public abstract class LayoutContent : LayoutElement, IXmlSerializable, ILayoutElementForFloatingWindow, IComparable<LayoutContent>, ILayoutPreviousContainer
    {
        ...
        public virtual void ReadXml(System.Xml.XmlReader reader)
        {
            ...
            if (reader.MoveToAttribute("GarbageCollectible"))
                GarbageCollectible = bool.Parse(reader.Value);
            ...
            if (reader.MoveToAttribute("DockSide"))
            {
                switch (reader.Value)
                {
                    case "Left":
                        DockSide = AnchorSide.Left;
                        break;
                    case "Right":
                        DockSide = AnchorSide.Right;
                        break;
                    case "Top":
                        DockSide = AnchorSide.Top;
                        break;
                    case "Bottom":
                        DockSide = AnchorSide.Bottom;
                        break;
                    case "None":
                        DockSide = AnchorSide.None;
                        break;
                }
            }
            reader.Read();
        ...
        #region DockSide
        /// <summary>
        /// The panel dock position. 
        /// Used for hide/show left/right panels.
        /// </summary>
        private AnchorSide _dockSide = AnchorSide.None;
        public AnchorSide DockSide
        {
