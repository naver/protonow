...
namespace Xceed.Wpf.AvalonDock.Layout
{
    ...
    public abstract class LayoutElement : DependencyObject, ILayoutElement
    {
        ...
        #region GarbageCollectible

        private bool _garbageCollectible = true;

        /// <summary>
        /// Indicates whether this <see cref="LayoutElement"/> can be eliminated during
        /// a call to <see cref="ILayoutRoot.CollectGarbage"/>
        /// </summary>
        public bool GarbageCollectible
        {
            get { return _garbageCollectible; }
            set
            {
                if (_garbageCollectible != value)
                {
                    RaisePropertyChanging("GarbageCollectible");
                    _garbageCollectible = value;
                    OnGarbageColelctibleChanged();
                    RaisePropertyChanged("GarbageCollectible");
                }
            }
        }

        protected virtual void OnGarbageColelctibleChanged()
        {
