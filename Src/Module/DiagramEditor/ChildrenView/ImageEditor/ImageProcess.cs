...
namespace Naver.Compass.Module
{
    class ImageProcess
    {
        ...
        static public void Rubber(int x, int y, int RubberWidth, int rubberHeight, WriteableBitmap image)
        {
            ...
            image.WritePixels(new System.Windows.Int32Rect(0, 0, image.PixelWidth, image.PixelHeight), ary, stride, 0);
        }

        public static BitmapSource RotateImage(BitmapSource image, float angle)
        {
            using (var outStream = new MemoryStream())
            {
                ...
                return Bitmap2BitmapImage(RotateImage(bitmap, angle));
            }
        }
        ...
        public static Size RotateSize(double width, double height, float angle)
        {
            const double pi2 = Math.PI / 2.0;
