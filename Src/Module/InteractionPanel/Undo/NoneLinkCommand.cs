...
{
    class NoneLinkCommand : IUndoableCommand
    {
        internal NoneLinkCommand(InteractionTabVM tabVM, bool oldValue, bool newValue, Guid targetWidgetGuid)
        {
            _tabVM = tabVM;
            _oldValue = oldValue;
            _newValue = newValue;
        ...
        public void Undo()
        {
            ...
            _tabVM.Raw_NoneChecked = _oldValue;
        }
        ...
        public void Redo()
        {
            ...
            _tabVM.Raw_NoneChecked = _newValue;
        }
